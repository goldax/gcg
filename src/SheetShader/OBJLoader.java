...
public class OBJLoader {
	 ...
	 *            reference to gl
	 */
	public OBJLoader(String name, float size, GL2 gl) {
...
//					texture.setTexParameteri(GL2.GL_TEXTURE_MAG_FILTER,
//					        GL2.GL_NEAREST);
//					texture.setTexParameteri(GL2.GL_TEXTURE_MIN_FILTER,
//					        GL2.GL_NEAREST);
				} catch (Exception e) {
     ...
     */
    public final int getDisplayList(GL2 gl) {
    	drawToList(gl);
    	return modelDisplayList;
    }
