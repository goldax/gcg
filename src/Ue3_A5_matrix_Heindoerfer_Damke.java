...
public class Ue3_A5_matrix_Heindoerfer_Damke extends Jogl2Template {	
	...
	public static void main(String[] args) {
		Ue3_A5_matrix_Heindoerfer_Damke template = new Ue3_A5_matrix_Heindoerfer_Damke();
	...
	public Consumer<GL2> matrix(float[] matrix) {
		return gl -> gl.glMultMatrixf(matrix, 0);
	}
	...
	public void drawTransformedLetters(GL2 gl) {
		float w = (float) (Math.sqrt(2) / 2f);
