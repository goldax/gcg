...
public class Ue4_A2_Heindoerfer_Damke extends Jogl2Template {	
	public class Letter {
		public float[][] verts;
		public int[][] quads;
	...
	public void display(GLAutoDrawable drawable) {
		...
		gl.glPolygonMode(gl.GL_FRONT, showFrontFaces ? gl.GL_FILL : gl.GL_LINE);
