...
public class Ue4_A3_Heindoerfer_Damke extends Jogl2Template {	
	...
	public static void main(String[] args) {
		Ue4_A3_Heindoerfer_Damke template = new Ue4_A3_Heindoerfer_Damke();
		template.setVisible(true);
	}
	
	private GLU glu = new GLU();
	private ProjectionMode pm = ProjectionMode.Perspective;
	...
	public void updateProjection(GL2 gl) {
		...
		switch(pm) {
		case Orthographic:
			gl.glOrtho(-15, 15, -15, 15, 1, 100);
			break;
		case Frustum:
			gl.glFrustum(-0.5f, 0.5f, -0.5f, 0.5f, 1, 100);
			break;
		case Perspective:
			glu.gluPerspective(30, (float) this.getWidth() / this.getHeight(), 1, 100);
			break;
		}
	...
	public void defaultView(GL2 gl) {
		gl.glMatrixMode(GL2.GL_MODELVIEW);
		gl.glLoadIdentity();
		gl.glTranslatef(0, 0, -50);
		gl.glRotatef(30, 1, 0, -0.2f);
	}
