...
public class Ue6_A5_Heindoerfer_Damke extends Jogl2Template {	
	public class Letter {
		public float[][] verts;
		public int[][] quads;
	...
	private float uniform_size = 0;
	private float[] uniform_color = new float[] { 0, 0.5f, 0.75f, 1 };
	
	public static void main(String[] args) {
		Ue6_A5_Heindoerfer_Damke template = new Ue6_A5_Heindoerfer_Damke();
	...
	public void display(GLAutoDrawable drawable) {
		...
		uniform_size = (uniform_size + 0.01f) % 3;
		uniform_color[0] = (uniform_color[0] + 0.01f) % 3;
		
		shader.updateUniform(gl, "size", uniform_size);
		shader.updateUniform(gl, "color", uniform_color);
