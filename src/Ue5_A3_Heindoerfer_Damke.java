...
public class Ue5_A3_Heindoerfer_Damke extends Jogl2Template {	
	public class Letter {
		public float[][] verts;
		public int[][] quads;
	...
	private CullingMode cullingMode = CullingMode.BACK;
	private char[] letterOrder = new char[] {'j', 'h', 'c', 'd'};
	private HashMap<Character, Letter> letters = new HashMap<>();
	
	public static void main(String[] args) {
		Ue5_A3_Heindoerfer_Damke template = new Ue5_A3_Heindoerfer_Damke();
	...
	public void display(GLAutoDrawable drawable) {
		...
		gl.glCullFace(cullingMode.mode);
		
		letters.get(letterOrder[shownLetter]).draw(gl);
	}
	
	public void printState() {
		System.out.format("ShownLetter: %d, DepthBuffer: %b, Culling Mode: %s, Culling Enabled: %b\n",
				shownLetter,
				depthBufferEnabled,
				cullingMode.name(),
				cullingEnabled);
